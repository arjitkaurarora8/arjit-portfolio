  ...
  const processSteps = [
    {
      ...
      images: [
        { src: "/walmart-1.svg", alt: "Walmart branding" },
        { src: "/walmart-2.svg", alt: "Seller dashboard" },
      ],
      imageLayout: "grid",
    },
    {
