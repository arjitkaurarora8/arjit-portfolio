...
//         </h2>
//         <p className="sm:pt-4 flex text-right text-neutral-500 text-sm sm:text-base font-normal leading-snug tracking-tight max-w-md sm:max-w-none">
//           Explore a few of my most impactful projects spanning Fintech, Web3,
//           AI, and SaaS.
//         </p>
//       </div>
...
//         <Link
//           href="/project"
//           className="flex-1 border md:border-r-0 border-emerald-700 group relative transition-all duration-800 ease-in-out sm:hover:flex-3 md:hover:flex-4 xl:hover:flex-[2.8] h-[300px] sm:h-[400px] md:h-[500px] lg:h-[550px] xl:h-[600px] 2xl:[660px] overflow-hidden rounded-2xl sm:rounded-l-2xl sm:rounded-r-none"
...
//           className="flex-1 group relative border md:border-l-0 border-emerald-700 transition-all duration-700 ease-in-out sm:hover:flex-1 md:hover:flex-1 lg:hover:flex-[2] xl:hover:flex-[3] h-[300px] sm:h-[400px] md:h-[500px] lg:h-[550px] xl:h-[600px] 2xl:[660px] overflow-hidden rounded-2xl sm:rounded-r-2xl sm:rounded-l-none"
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row w-full pt-4 gap-4 sm:gap-0">
        ...
        <Link
          ...
          style={{ cursor: "none" }}
        >
          <div className="w-full h-full bg-no-repeat bg-cover bg-left sm:bg-left-top min-h-[300px] bg-work1-mobile md:bg-work1-desktop"></div>
        ...
        <Link
          ...
          style={{ cursor: "none" }}
        >
          <div className="w-full h-full bg-no-repeat bg-cover bg-left sm:bg-left-top min-h-[300px] bg-work2-mobile md:bg-work2-desktop"></div>
